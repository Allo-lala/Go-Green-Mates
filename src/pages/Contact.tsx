                ...
                <div className="bg-white/95 dark:bg-gray-900/95 rounded-xl p-6 space-y-6 backdrop-blur-sm">
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex space-x-3">
                      <a href=" " target="_blank" className=" hover:text-white" aria-label="Twitter">
                      ...
                      < a href=" " target="_blank" className=" hover:text-white" aria-label="Instagram"> 
                      ...
                      <a href="  " target="_blank" className=" hover:text-white" aria-label="Tiktok">
                      ...
                      <a href=" " target="_blank" className=" hover:text-white" aria-label="Youtube">
